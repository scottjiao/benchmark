...
fixed_info={}
task_to_evaluate=[{"net":"slotGAT","search_num_layers":"[2,3,4]","slot_aggregator":"onedimconv","search_hidden_dim":"[64,128]"}]
gpus=["0","1"]
total_trial_num=50
task_str=''
...
for dataset,worker_num,re in dataset_to_evaluate:
    for task in task_to_evaluate:
        ...
        study_name=f"techniques_{dataset}_net_{task['net']}_onedimconv"

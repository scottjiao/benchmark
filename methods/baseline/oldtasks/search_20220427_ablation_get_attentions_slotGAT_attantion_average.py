...
task_to_evaluate=[
{"net":"slotGAT","feats-type":"0","slot_aggregator":"last_fc","attention_average":"True"},
{"net":"slotGAT","feats-type":"1","slot_aggregator":"last_fc","attention_average":"True"},
{"net":"slotGAT","feats-type":"2","slot_aggregator":"last_fc","attention_average":"True"},
{"net":"slotGAT","feats-type":"3","slot_aggregator":"last_fc","attention_average":"True"},
{"net":"slotGAT","feats-type":"0","slot_aggregator":"average","attention_average":"True"},
{"net":"slotGAT","feats-type":"1","slot_aggregator":"average","attention_average":"True"},
{"net":"slotGAT","feats-type":"2","slot_aggregator":"average","attention_average":"True"},
{"net":"slotGAT","feats-type":"3","slot_aggregator":"average","attention_average":"True"},
]
gpus=["0"]
total_trial_num=1
...
for dataset,worker_num,repeat in dataset_to_evaluate:
    for task in task_to_evaluate:
        ...
        yes=["technique","corrected","feat_type",f"feat_type_{task['feats-type']}",f"aggr_{task['slot_aggregator']}","attantion_average"]
        no=[]
        ...
        study_name=f"get_attentions_{dataset}_net_{task['net']}_feats_type_{task['feats-type']}_slot_aggregator{task['slot_aggregator']}_attantion_average_True"

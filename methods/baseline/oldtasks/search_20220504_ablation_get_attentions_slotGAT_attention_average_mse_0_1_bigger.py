...
for dataset,worker_num,repeat in dataset_to_evaluate:
    for task in task_to_evaluate:
        ...
        f"0_type_bigger_{task['attention_0_type_bigger_constraint']}",
        f"1_type_bigger_{task['attention_1_type_bigger_constraint']}"]
        no=[]
        ...
        study_name=f"get_attentions_{dataset}_net_{task['net']}_feats_type_{task['feats-type']}_slot_aggregator{task['slot_aggregator']}_attention_mse_sampling_{task['attention_mse_sampling_factor']}_weight_{task['attention_mse_weight_factor']}_0_type_bigger_{task['attention_0_type_bigger_constraint']}_1_type_bigger_{task['attention_1_type_bigger_constraint']}"

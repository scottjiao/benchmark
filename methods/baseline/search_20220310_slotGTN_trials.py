...
fixed_info={""}
task_to_evaluate=[{"net":"slotGTN","search_num_layers":"[2,4,8,16]","search_hidden_dim":"[64]","normalize":"True","search_lr_times_on_filter_GTN":"[1]"},
{"net":"slotGTN","search_num_layers":"[2,4,8,16]","search_hidden_dim":"[64]","normalize":"False","search_lr_times_on_filter_GTN":"[1]"},
{"net":"slotGTN","search_num_layers":"[2,4,8,16]","search_hidden_dim":"[64]","normalize":"False","search_lr_times_on_filter_GTN":"[100]"},{"net":"slotGTN","search_num_layers":"[2,4,8,16]","search_hidden_dim":"[64]","normalize":"True","search_lr_times_on_filter_GTN":"[100]"},
]
gpus=["0","1"]
total_trial_num=30
task_str=''
...
for dataset,worker_num,re in dataset_to_evaluate:
    for task in task_to_evaluate:
        ...
        study_name=f"techniques_{dataset}_net_{task['net']}_{task['slot_aggregator']}_slottrans_{task['slot_trans']}"

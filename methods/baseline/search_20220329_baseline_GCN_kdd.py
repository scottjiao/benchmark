...
dataset_to_evaluate=[("DBLP",2,10),("ACM",2,10),("IMDB",2,10),("Freebase",1,20)]

fixed_info={"net":"GCN","search_num_layers":"[2,3,4]","search_hidden_dim":"[64,128]"}
task_to_evaluate=[
{"feats-type":"0",},
{"feats-type":"2",},
]
...
for dataset,worker_num,re in dataset_to_evaluate:
    for task in task_to_evaluate:
        ...
        study_name=f"baseline_{dataset}_kdd_net_{fixed_info['net']}_feat_type_{task['feats-type']}"

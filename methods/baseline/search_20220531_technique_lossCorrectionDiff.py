...
dataset_to_evaluate=[("IMDB_corrected",2,20),]  # dataset,worker_num,repeat

prefix="technique";specified_args=["dataset",   "net",    "feats-type",     "slot_aggregator","LossCorrectionAbsDiff"]


fixed_info={"task_property":prefix,"net":"slotGAT",}
task_to_evaluate=[
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","LossCorrectionAbsDiff":"True","slot_aggregator":"average","feats-type":1},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","LossCorrectionAbsDiff":"True","slot_aggregator":"onedimconv","feats-type":1},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","LossCorrectionAbsDiff":"True","slot_aggregator":"last_fc","feats-type":1},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","LossCorrectionAbsDiff":"True","slot_aggregator":"average","feats-type":0},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","LossCorrectionAbsDiff":"True","slot_aggregator":"onedimconv","feats-type":0},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","LossCorrectionAbsDiff":"True","slot_aggregator":"last_fc","feats-type":0},
]
gpus=["0","1"]
total_trial_num=30

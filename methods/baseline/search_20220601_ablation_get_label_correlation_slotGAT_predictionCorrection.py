...
prefix="ablation";specified_args=["dataset",   "net",    "feats-type",     "slot_aggregator","predictionCorrectionTrainBeta"]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"average","get_out":"True"}
task_to_evaluate=[
{"feats-type":"1","predictionCorrectionTrainBeta":1,"predictionCorrectionRelu":"True"},
]
gpus=["1"]
total_trial_num=1

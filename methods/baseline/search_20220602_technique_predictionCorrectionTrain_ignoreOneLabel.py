...
prefix="technique";specified_args=["dataset",   "net",    "feats-type",     "slot_aggregator","predictionCorrectionTrainBeta","predCorIgnoreOneLabel"]


fixed_info={"task_property":prefix,"net":"slotGAT","feats-type":1,"slot_aggregator":"average","predCorIgnoreOneLabel":"True"}
task_to_evaluate=[
#{"feats-type":"1","predicted_by_slot":"majority_voting"},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","predictionCorrectionTrainBeta":5e-1,"predictionCorrectionRelu":"True"},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","predictionCorrectionTrainBeta":1,"predictionCorrectionRelu":"True"},
{"search_hidden_dim":"[64,128]","search_num_layers":"[2,3]","predictionCorrectionTrainBeta":2,"predictionCorrectionRelu":"True"},
]
gpus=["0","1"]
total_trial_num=30

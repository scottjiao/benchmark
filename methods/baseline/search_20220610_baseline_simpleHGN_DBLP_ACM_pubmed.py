...
dataset_to_evaluate=[("DBLP_corrected",2,10),("ACM_corrected",2,10),("pubmed_HNE_complete",1,20),]  # dataset,worker_num,repeat

prefix="baseline";specified_args=["dataset",   "net",    "feats-type","search_hidden_dim","search_num_layers"]


fixed_info={"task_property":prefix,"net":"changedGAT"}
task_to_evaluate=[

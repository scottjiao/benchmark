...
dataset_to_evaluate=[("pubmed_HNE_complete",1,20),]  # dataset,worker_num,repeat
...
fixed_info={"task_property":prefix,"net":"slotGAT","feats-type":1,"slot_aggregator":"average","predicted_by_slot":"max"}
task_to_evaluate=[
#{"feats-type":"1","predicted_by_slot":"majority_voting"},
#{"search_hidden_dim":"[64]","search_num_layers":"[2]"},
#{"search_hidden_dim":"[64]","search_num_layers":"[3]"},
#{"search_hidden_dim":"[128]","search_num_layers":"[2]"},
{"search_hidden_dim":"[128]","search_num_layers":"[3]"},
]
gpus=["0","1"]
total_trial_num=8

...
prefix="online_evaluation";specified_args=["dataset",   "net",    "feats-type",     "slot_aggregator",]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"average","get_test_for_online":"True","using_optuna":"False"}
task_to_evaluate=[
{"search_hidden_dim":"[64]","search_num_layers":"[2]","search_lr":"[0.0001]","search_weight_decay":"[0.0005]","feats-type":"1","predicted_by_slot":"max"},
]
gpus=["0"]
total_trial_num=1

...
dataset_to_evaluate=[("DBLP_corrected",1,10)]   # dataset,worker_num,repeat

prefix="technique_newCsv";specified_args=["dataset",   "net",      "slot_aggregator"]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"max","using_optuna":"False"}
task_space={"search_hidden_dim":"[64,128]","search_num_layers":"[2,3,4]","search_lr":"[1e-3,5e-4,1e-4]","search_weight_decay":"[1e-3,5e-4,1e-4]","feats-type":1}

gpus=["1"]
total_trial_num=1 #useless

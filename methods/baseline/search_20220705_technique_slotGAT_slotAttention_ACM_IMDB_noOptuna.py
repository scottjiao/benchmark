...
dataset_to_evaluate=[("IMDB_corrected",1,10),("ACM_corrected",1,10),]   # dataset,worker_num,repeat

prefix="technique_newCsv";specified_args=["dataset",   "net",      "slot_aggregator","slot_attention"]


fixed_info={"task_property":prefix,"net":"slotGAT","slot_aggregator":"average","using_optuna":"False","slot_attention":"True"}
